...
public class Player : MonoBehaviour
{
    ...
    void Run()
    {
        rb.velocity = new Vector2(runSpeed * CrossPlatformInputManager.GetAxis("Horizontal"), rb.velocity.y);
    ...
    void ClimbLadder()
    {
        ...
        rb.velocity = new Vector2(rb.velocity.x, CrossPlatformInputManager.GetAxis("Vertical") * climbSpeed);
        rb.gravityScale = 0f;
